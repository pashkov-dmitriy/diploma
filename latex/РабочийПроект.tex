...
\begin{figure}[!htb]
\center{\includegraphics[width=1\linewidth]{stestLoginEmpty}}
...
\begin{figure}[!htb]
	\center{\includegraphics[width=1\linewidth]{stestReg}}
...
\begin{figure}[!htb]
	\center{\includegraphics[width=1\linewidth]{stestHome}}
...
\begin{figure}[!htb]
	\center{\includegraphics[width=1\linewidth]{stestSearchFail}}
...
\begin{figure}[!htb]
	\center{\includegraphics[width=1\linewidth]{stestArtist}}
...
\begin{figure}[!htb]
	\center{\includegraphics[width=1\linewidth]{stestAlbum}}
...
\begin{figure}[!htb]
	\center{\includegraphics[width=1\linewidth]{stestPlayer}}
...
\begin{figure}[!htb]
	\center{\includegraphics[width=1\linewidth]{stestUserBefore}}
...
\begin{figure}[!htb]
	\center{\includegraphics[width=1\linewidth]{stestUserAfter}}
